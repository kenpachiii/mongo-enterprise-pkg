...
class PostgresqlHandler extends DatabaseHandler {
  ...
  createDatabaseForApp(name, options) {
    ...
    postgresqlCore.createUser(
      ...
      _.extend(options, this.connection, {newUserPassword: databaseSettings.password})
    );
    ...
    this.appDatabase = _.assign(new PostgresqlDatabase(this.connection), databaseSettings);
  }
